  ...
  const items = useMemo<Item[]>(() => {
    ...
    if (!dq) {
      ...
      return [
        ...
        { key: "galaxy", title: "Galaxy", group: "Go to", hint: "the library as solar systems and universes", run: go({ kind: "galaxy" }) },
        ...
        { key: "lab-studio", title: "Studio", group: "Go to", hint: "agentic cinema: shots, takes, critics", run: go({ kind: "lab", studio: true }) },
        { key: "lab-traces", title: "Traces", group: "Go to", hint: "your data collector", run: go({ kind: "lab", traces: true }) },
